...
I would, however, still produce those poor quality code from time to time anyway&mdash;at least unwillingly.. does that count?&mdash;to meet the time constrains of a particular task that I was assigned to at the moment, and make things work by then.
